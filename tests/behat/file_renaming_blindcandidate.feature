...
Feature: Blind marking, candidate number based file renaming for submission files

  As a teacher
  I want submitted files to be renamed with candidate numbers when using candidate providers with blind marking enabled
