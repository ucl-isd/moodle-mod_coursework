...
$string['automaticagreementgradebands_form_desc'] = "These bands will determine if grades can be averaged automatically. Grades within the same band will be averaged if they are close enough in percentage terms, but if grades fall across different bands, an agreed grade must be entered manually.";
...
$string['changessavedclassboundaries'] = 'Changes saved to class boundaries';
...
$string['gradeboundariessettingfor'] = 'Setting grade class boundaries for \'{$a}\'';
...
$string['gradeclasssetboundariesforautograder'] = 'Set default system level grade class boundaries for automatic agreement average grade (no straddling of class boundaries)';
...
$string['gradeclasssetboundariessettingsystem'] = 'Setting default system level grade class boundaries';
