...
$string['allocateassessorsandmoderators'] = 'Allocate assessors';
...
$string['allocationcheckboxtitle'] = 'Include {$a} in the moderation set';
...
$string['cron_email_html'] = '<p>Dear {$a->name},</p> <p>We wish to remind you that your assignment for {$a->coursework_name} is due on {$a->human_deadline}. '. 'You have {$a->day_hour} to complete it</p> <p>Regards,<br /> Course Admin </p> ';
...
$string['currentmoderationset'] = 'Current moderation set';
...
$string['define_moderation_set'] = 'Define moderation set';
$string['define_moderation_set_help'] = 'Moderation sets are additive, so as each rule is run, the students it identified are added to the set, then the whole set is used for moderation. Add the rules one by one using the options below.';
$string['definemoderationset'] = 'Define the moderation set';
...
$string['gradeeditingtime_help'] = 'The amount of time given to allow for editing of grade after it is first entered NOTE: The edit your own intial grades capability overrides this option allowing a user to edit at all times';
...
$string['moderationset_help'] = 'The moderation set determines which students are to be moderated. The others will not be visible to the moderator. This is optional, and if no rules are supplied, it will be assumed that all students should be moderated.';
...
$string['modsetgradeexplain'] = 'Please note: This moderation set rule will not be activated until initial grading has commenced. The moderation sample will continue to include all qualifying assignments, based upon the set rule chosen.' ;
...
$string['saveandfinalise'] = 'Submit and finalise';
...
$string['unmoderatedworkexists'] = 'Cannot release grades - some work still needs moderating and strict anonymity for moderation is enabled.';
