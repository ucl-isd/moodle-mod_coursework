...
$string['automaticagreementpercentagedistancenostraddling'] = "Percentage distance (no straddling class boundaries)";
$string['automaticagreementrange'] = "Automatic agreement range %";
$string['automaticagreementrange_form_desc'] = "These bands will determine if grades can be averaged automatically. Grades within the same band will be averaged if they are close enough in percentage terms, but if grades fall across different bands, an agreed grade must be entered manually.";
$string['automaticagreementrange_help'] = "For mark differences of less than this percentage, the agreed mark will be calculated by mathematical averaging, unless the grades straddle class boundaries and no straddling is selected";
