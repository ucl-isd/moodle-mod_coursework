...
$string['automaticagreementrange_form_desc'] = "These class boundaries will be used to decide whether or not to average grades automatically for agreement purposes.  Grades must be in the same band to be averaged automatically. Otherwise the agreed grade must be entered manually.";
...
$string['gradeboundarybottom'] = 'Grade boundary bottom %';
$string['gradeboundarytop'] = 'Grade boundary top %';
