...
class student_submission_form extends moodleform {
    ...
    public function set_data($submission) {
        ...
        $s = submission::get_from_id($data->submissionid);
        $s->clear_cache();
    }
    ...
    protected function add_file_manager_to_form() {
        ...
        $this->_form->addRule('submission_manager', get_string('submissionfilesrequired', 'coursework'), 'required', null, 'server', false, true);
    }
