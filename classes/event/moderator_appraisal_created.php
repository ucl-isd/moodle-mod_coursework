...
/**
 * Event for creating a moderator appraisal record.
 *
...
class moderator_appraisal_created extends base {
    /**
     * Init method.
     */
    ...
    public static function get_name() {
        return get_string('moderatorappraisalcreated', 'mod_coursework');
    }
    ...
    public function get_description() {
        return "The user with ID '{$this->userid}' created moderator appraisal ID '{$this->objectid}'"
