...
/**
 * Event for deleting a moderator appraisal record.
 *
...
class moderator_appraisal_deleted extends base {
    /**
     * Init method.
     */
    ...
    public static function get_name() {
        return get_string('moderatorappraisaldeleted', 'mod_coursework');
    }
    ...
    public function get_description() {
        return "The user with ID '{$this->userid}' deleted moderator appraisal ID '{$this->objectid}'"
